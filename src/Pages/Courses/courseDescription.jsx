                        ...
                        <div className="flex flex-col items-center justify-between text-xl">
                          ...
                          {/* conditional Rendering */}
                          {
                            role === "ADMIN"  || data?.subscribtion?.status === "ACTIVE" ? (
                                <button className="bg-yellow-600 text-xl rounded-md font-bold px-5 py-3 w-full hover:bg-yellow-500 transition-all ease-in-out duration-300 hover:cursor-pointer">
                                    Watch Lectures
                                </button>
                            ):(
                                <button className="bg-yellow-600 text-xl rounded-md font-bold px-5 py-3 w-full hover:bg-yellow-500 transition-all ease-in-out duration-300 hover:cursor-pointer">
